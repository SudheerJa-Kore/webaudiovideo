package com.audiocodes.mv.webrtcclient.db;
...
public class NativeDBManager {
    ...
    public static List<NativeDBObject>  getContactList(QueryType searchType, String value) {
        ...
        while (cur != null && cur.moveToNext()) {
            long id = cur.getLong(cur.getColumnIndex(Data.CONTACT_ID));
            String name = cur.getString(cur.getColumnIndex(Contacts.DISPLAY_NAME));
            String mime = cur.getString(cur.getColumnIndex(Contacts.Data.MIMETYPE));
            String data = cur.getString(cur.getColumnIndex(Contacts.Data.DATA1));
            String dataType = cur.getString(cur.getColumnIndex(Contacts.Data.DATA2));
            String photo = cur.getString(cur.getColumnIndex(Data.PHOTO_URI));
            String thumb = cur.getString(cur.getColumnIndex(Data.PHOTO_THUMBNAIL_URI));
