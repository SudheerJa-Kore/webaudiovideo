...
public class BasePrefs {
    ...
    private static final SharedPreferences sharedPreferences = MainApp.getGlobalContext().getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);
    private static final SharedPreferences.Editor editorSP = sharedPreferences.edit();
