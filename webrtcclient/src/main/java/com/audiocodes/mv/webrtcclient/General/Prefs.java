...
public class Prefs extends BasePrefs {
    ...
    public static Log.LogLevel getLogLevel()
    {
        ...
        String defaultLogLevel = MainApp.getGlobalContext().getString(R.string.log_level_default);
...
//    {
//        AudioManager audioManager = (AudioManager)MainApp.getGlobalContext().getSystemService("audio");
