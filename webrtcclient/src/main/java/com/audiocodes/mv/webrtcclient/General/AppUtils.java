...
public class AppUtils {
    ...
    public static boolean getStringBoolean(int stringId){
        try {
            String value = MainApp.getGlobalContext().getString(stringId);
            if ("1".equals(value)) {
                return true;
            }
        } catch (Exception e) {
    ...
    public static Transport getTransport(String name)
    {
        ...
        try {
            ...
            transport= Transport.valueOf(MainApp.getGlobalContext().getString(R.string.sip_account_transport_default));//  Transport.TCP;
        }
        return transport;
    }
...
//    }
    ...
    public static void startRingingMP(String fullPath, boolean isLooping, boolean useSpeaker,
        ...
        try {
            ...
            audioManager.setStreamVolume(stramType, newVolume, AudioManager.MODE_NORMAL);
    ...
    public static void saveVolumeSettings(boolean prevVol) {
        ...
        if (prevVol) {
            //save old volume
            AudioManager audioManager = (AudioManager) MainApp.getGlobalContext().getSystemService(Context.AUDIO_SERVICE);
